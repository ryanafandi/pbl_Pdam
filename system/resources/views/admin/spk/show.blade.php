                ...
                <div class="col-md-5 mb-3">
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            @if ($status === 'draft')
                                <form action="{{ url('admin/spk/' . $row->id . '/kirim') }}" method="POST"
                            ...
                            <div class="btn-group">
                                {{-- Tombol Print (Admin bisa print) --}}
                                <a href="{{ route('admin.spk.print', $row->id) }}" target="_blank"
                            ...
                            @if ($status === 'kirim_direktur')
                                <form action="{{ url('admin/spk/' . $row->id . '/approve') }}" method="POST"
                                    class="mb-2 d-inline-block">
                                    @csrf
                                ...
                                <form id="form-tolak-{{ $row->id }}"
                                    action="{{ url('admin/spk/' . $row->id . '/reject') }}" method="POST"
                                    class="d-none">
                                    @csrf
                            ...
                            @if ($status === 'disetujui')
                                <form action="{{ url('admin/spk/' . $row->id . '/selesai') }}" method="POST"
